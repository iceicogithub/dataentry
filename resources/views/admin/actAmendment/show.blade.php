            ...
            <div class="col-sm-12">
                    ...
                    <div class="card p-5">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-sm-12 col-lg-10 border p-0 p-2 pl-3">{{ $actAmendment->act_amendment_title }}</div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 col-sm-12 col-lg-2 border p-0 p-2 pl-3 font-weight-bold">Document Type
                            </div>
                            <div class="col-md-10 col-sm-12 col-lg-10 border p-0 p-2 pl-3">Act Amendment</div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-10 col-sm-12 col-lg-10 border p-0 p-2 pl-3">
                                <a href="{{ asset('admin/uploads/' . $actAmendment->act_amendment_pdf) }}" class="text-primary">Download PDF</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 col-sm-12 col-lg-2 border p-0 p-2 pl-3 font-weight-bold">Created At</div>
                            <div class="col-md-10 col-sm-12 col-lg-10 border p-0 p-2 pl-3">{{ $actAmendment->created_at }}</div>
                        </div>
                    </div>  
            </div>
        </div>
