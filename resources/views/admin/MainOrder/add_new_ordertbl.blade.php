...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/add_new_ordertbl" method="post"
                    ...
                    @endif
                    <input type="hidden" name="click_order_id" value="{{ $orderTable->orders_id }}">
                    <input type="hidden" name="click_order_rank" value="{{ $orderTable->orders_rank }}">
                                ...
                                <div>
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            null
                                            @endif
                                            <textarea name="order_main_title" class="form-control mb-3 rule_main_title" placeholder="Enter Title" id="order_main_title">{{ $orderTable->mainOrder->order_main_title }}</textarea>
                                        </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            CKEDITOR.replace('orders_content');
            CKEDITOR.replace('orders_title');
