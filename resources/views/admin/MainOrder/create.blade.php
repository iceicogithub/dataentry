...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="/edit_new_scheme_guidelines/{{ $newOrder->new_order_id }}"><button class="btn btn-danger">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_order/{{ $newOrder->new_order_id }}" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="new_order_title" class="form-control mb-3"
                                        placeholder="Enter Order Title" value="{{ $newOrder->new_order_title }}">
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.add-chapter', function() {
                    ...
                    CKEDITOR.replace($('.section-set:last').find('.order_main_title')[0]);
                    CKEDITOR.replace($('.section-set:last').find('.parts_title')[0]);
