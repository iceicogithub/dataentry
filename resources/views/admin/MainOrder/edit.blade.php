...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="{{ url('/edit_new_order/' . $orderTable->new_order_id . '?perPage=10&page=' . $currentPage) }}"><button class="btn btn-success">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/update_main_order/{{ $orderTable->orders_id }}" method="post"
                    ...
                    @endif
                    <input type="hidden" name="section_id" value="{{ $orderTable->orders_id }}">
                    <input type="hidden" name="currentPage" value="{{ $currentPage }}">
                    <input type="hidden" name="order_main_id" value="{{ $orderTable->order_main_id }}">
                    <input type="hidden" name="new_order_id" value="{{ $orderTable->new_order_id }}">
                    <input type="hidden" name="order_subtypes_id" value="{{ $orderTable->order_subtypes_id }}">
                    <div class="card p-5">
                                ...
                                <div>
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            @if ($orderTable->mainOrder->order_maintype_id == 1)
                                            <label class="float-label font-weight-bold">Chapter :</label>
                                            @elseif($orderTable->mainOrder->order_maintype_id == 2)
                                            <label class="float-label font-weight-bold">Schedule :</label>
                                            @elseif($orderTable->mainOrder->order_maintype_id == 3)
                                            <label class="float-label font-weight-bold">Preliminary :</label>
                                            @elseif($orderTable->mainOrder->order_maintype_id == 4)
                                            <label class="float-label font-weight-bold">Part :</label>
                                            @elseif($orderTable->mainOrder->order_maintype_id == 5)
                                            <label class="float-label font-weight-bold">Appendix :</label>
                                            @elseif($orderTable->mainOrder->order_maintype_id == 6)
                                            <label class="float-label font-weight-bold">Form :</label>
                                            @else
                                            null
                                            @endif
                                            <textarea name="order_main_title" class="form-control mb-3 regulation_main_title" placeholder="Enter Title" id="order_main_title">{{ $orderTable->mainOrder->order_main_title }}</textarea>
                                        </div>

                                        <div class="form-group form-default" style="display: block">
                                            @if ($orderTable->order_subtypes_id == 1)
                                            <label class="float-label font-weight-bold">Scheme :</label>
                                            @elseif($orderTable->order_subtypes_id == 2)
                                            <label class="float-label font-weight-bold">Guidelines:</label>
                                            @elseif($orderTable->order_subtypes_id == 3)
                                            <label class="float-label font-weight-bold">List :</label>
                                            @elseif($orderTable->order_subtypes_id == 4)
                                            <label class="float-label font-weight-bold">Part :</label>
                                            @elseif($orderTable->order_subtypes_id == 5)
                                            <label class="float-label font-weight-bold">Appendices :</label>
                                            @elseif($orderTable->order_subtypes_id == 6)
                                            <label class="float-label font-weight-bold">Order :</label>
                                            @elseif($orderTable->order_subtypes_id == 7)
                                            <label class="float-label font-weight-bold">Annexure :</label>
                                            @elseif($orderTable->order_subtypes_id == 8)
                                            <label class="float-label font-weight-bold">Schedule :</label>
                                            @elseif($orderTable->order_subtypes_id == 9)
                                            <label class="float-label font-weight-bold">Form :</label>
                                            @else
                                            null
                                            @endif
                                            
                                            <input type="text" name="orders_no" class="form-control my-3"
                                                style="width: 20%;" placeholder="Enter NO."
                                                value="{{ $orderTable->orders_no }}">
                                                <textarea type="text" id="orders_title" name="orders_title"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Title">{{ $orderTable->orders_title }}</textarea>
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            null
                                            @endif
                                            <textarea type="text" id="orders_content" name="orders_content"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Section">{{ $orderTable->orders_content }}</textarea>

                                            <div class="footnote-addition-container">
                                                @if (!empty($orderTable->orderFootnoteModel))
                                                    @foreach ($orderTable->orderFootnoteModel as $ky => $footnote)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        ...
                                                                        <div>
                                                                            <a href="{{ url('/delete_order_footnote/' . $footnote->order_footnote_id. '?perPage=10&page=' . $currentPage ) }}"
                                                                    ...
                                                                    <div class="show-footnote" style="display: block">
                                                                        ...
                                                                        <input type="hidden"
                                                                            ...
                                                                            value="{{ $footnote->order_footnote_id }}">
                                                ...
                                                @if (count($orderTable->orderFootnoteModel) < 1)
                                        ...
                                        @if ($orderSubs->count() > 0)
                                            @foreach ($orderSubs as $k => $orderSub)
                                                <div class="multi-addition-container col-md-12 px-0">
                                                    <div class="multi-addition">
                                                        ...
                                                        <input type="hidden" name="order_sub_id[{{ $k }}]"
                                                            value="{{ $orderSub->order_sub_id }}">
                                                        <div class="border col-md-12 p-3">
                                                            <div
                                                                class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                                <span>
                                                                    @if ($orderSub->order_subtypes_id == 1)
                                                                    <label class="float-label font-weight-bold">Add Sub Scheme :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 2)
                                                                    <label class="float-label font-weight-bold">Add Sub Guidelines :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 3)
                                                                    <label class="float-label font-weight-bold">Add Sub List  :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 4)
                                                                    <label class="float-label font-weight-bold">Add Sub Part :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 5)
                                                                    <label class="float-label font-weight-bold">Add Sub Appendices :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 6)
                                                                    <label class="float-label font-weight-bold">Add Sub Order :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 7)
                                                                    <label class="float-label font-weight-bold">Add Sub Annexure :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 8)
                                                                    <label class="float-label font-weight-bold">Add Sub Schedule :</label>
                                                                    @elseif($orderSub->order_subtypes_id == 9)
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        <i
                                                                            class="fa {{ $orderSub->order_sub_no ? 'fa-minus' : 'fa-plus' }}"></i>
                                                                    </button>
                                                               </span>
                                                                ...
                                                                <div class="show-sub_section">
                                                                    <span class="d-flex">
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $orderSub->order_sub_no ?? '' }}"
                                                                            placeholder="Enter Sub-Section No."
                                                                            style="width: 20%;"
                                                                            data-index="{{ $k }}">

                                                                    </span>
                                                                    <textarea type="text" name="order_sub_content[{{ $k }}]"
                                                                        class="form-control ckeditor-replace sub_section">{{ $orderSub->order_sub_content ?? '' }}</textarea>
                                                                </div>
                                                            </div>

                                                            @if (count($orderSub->orderSubFootnoteModel) > 0)
                                                            @foreach ($orderSub->orderSubFootnoteModel as $a => $footnoteItem)
                                                                <input type="hidden"
                                                                    name="sub_footnote_id[{{ $k }}][{{ $a }}]"
                                                                    value="{{ $footnoteItem->order_footnote_id }}">
                                                                <div class="border col-md-12 p-3">
                                                                    <div
                                                                        class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                                        <div class="d-flex justify-content-between">
                                                                            ...
                                                                            <div>
                                                                                <a href="{{ url('/delete_order_footnote/' . $footnoteItem->order_footnote_id) }}"
                                                                                    onclick="return confirm('Are you sure ?')"><i
                                                                                        class="bg-danger btn-sm fa fa-trash p-1 text-white"></i></a>
                                                                            </div>
                                                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.add-multi-addition', function() {
                var orderSubtypesId = {{ $orderTable->order_subtypes_id  }};
                console.log(orderSubtypesId);

                var labelText;

switch (orderSubtypesId) {
    case 1:
    ...
    default:
        labelText = "null";
                                        ...
                                        <div>
                                            <div class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                ...
                                                <div class="show-sub_section" style="display: none">
                                                    <span class="d-flex"><input type="text" name="order_sub_no[${sectionCounterIndex}]" class="form-control mb-3" style="width: 20%" placeholder="Enter No." data-index="${sectionCounterIndex}"></span>
                                                    <textarea type="text" name="order_sub_content[${sectionCounterIndex}]" class="form-control ckeditor-replace sub_section" placeholder="Enter Ttile"></textarea>
                                                </div>
                                            </div>
                                        </div>
                ...
                $('.multi-addition').each(function(index) {
                    var newIndex = index;
                    $(this).find(`[name^="order_sub_no["]`).attr('name',
                        `order_sub_no[${newIndex}]`);
                    $(this).find(`[name^="order_sub_content["]`).attr('name',
                        `order_sub_content[${newIndex}]`);
            ...
            $(document).on('click', '.add-multi-footnote2', function() {
                ...
                var associatedSubSectionTitle = multiAdditionContainer.find('[name^="order_sub_no["]');
