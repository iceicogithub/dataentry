...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_notifications" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="notifications_title" class="form-control mb-3"
                                        placeholder="Enter Notification" required id="notifications_title">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-default">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="notifications_date" value=""
                                        class="form-control mb-3" id="notifications_date" placeholder="Enter Act Date">
                                </div>
                            </div>
                            <div class="col-md-12">
