...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="{{ route('get_release', array_merge(['id' => $release->act_id], ['page' => $currentPage])) }}">
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/update_release/{{$release->release_id}}" method="post" enctype="multipart/form-data"
                        ...
                        @endif
                        <input type="hidden" name="act_id" id="act_id" value="{{$release->act_id}}">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="release_title" class="form-control mb-3"
                                        placeholder="Enter Press Release" required value="{{$release->release_title}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <textarea name="release_no" id="release_no" class="form-control mb-3" placeholder="Enter Press Release No" cols="30"
                                        rows="3">{{$release->release_no}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <textarea type="text" name="ministry" value=""
                                        class="form-control mb-3" id="ministry">{{$release->ministry}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    <label class="float-label">Press Release Date<span class="text-danger">*</span></label>
                                    <input type="text" name="release_date" value="{{$release->release_date}}"
