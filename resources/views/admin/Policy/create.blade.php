...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="{{ Route('get_policy',array_merge(['id' => $id], ['page' => $currentPage])) }}"><button class="btn btn-success">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_policy" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="policy_title" class="form-control mb-3"
                                        placeholder="Enter Policy" required id="policy_title">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-default">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="policy_date" value=""
