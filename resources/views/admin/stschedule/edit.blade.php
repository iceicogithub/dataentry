...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/update_all_stschedule/{{ $stschedule->stschedule_id }}" method="post"
                                    ...
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            @elseif($stschedule->maintype_id == 2)
                                                ...
                                                <textarea name="parts_title" class="form-control mb-3 parts_title" placeholder="Enter Parts Title" id="p_title">{{ $stschedule->Partmodel->parts_title }}</textarea>
                                            @elseif($stschedule->maintype_id == 3)
                                                <label class="float-label font-weight-bold">Priliminary :</label>

                                                <textarea name="parts_title" class="form-control mb-3 parts_title" placeholder="Enter Parts Title" id="pr_title">{{ $stschedule->Priliminarymodel->priliminary_title }}</textarea>
                                            @elseif($stschedule->maintype_id == 4)
                                                ...
                                                <textarea name="schedule_title" class="form-control mb-3 schedule_title" placeholder="Enter Schedule Title"
                                                    id="s_title">{{ $stschedule->Schedulemodel->schedule_title }}</textarea>
                                            @elseif($stschedule->maintype_id == 5)
                                                ...
                                                <textarea name="appendix_title" class="form-control mb-3 appendix_title" placeholder="Enter Appendix Title"
                                                    id="a_title">{{ $stschedule->Appendixmodel->appendix_title }}</textarea>
                                            @elseif($stschedule->maintype_id == 6)
                                                ...
                                                <textarea name="main_order_title" class="form-control mb-3 main_order_title" placeholder="Enter Order Title"
                                                    id="m_title">{{ $stschedule->MainOrderModel->main_order_title }}</textarea>
                                            @else
                                                null
                                            @endif
                                        </div>
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            <input type="text" name="stschedule_no" class="form-control my-3"
                                                style="width: 20%;" placeholder="Enter Schedule NO."
                                                value="{{ $stschedule->stschedule_no }}">

                                            <textarea type="text" id="stschedule_title" name="stschedule_title"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Schedule Title">{{ $stschedule->stschedule_title }}</textarea>
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            <textarea type="text" id="stschedule" name="stschedule_content"
                                                class="form-control stschedule-textarea ckeditor-replace stschedule" placeholder="Enter Schedule">{{ $stschedule->stschedule_content }}</textarea>

                                            <div class="footnote-addition-container">
                                                @if ($substschedule->isNotEmpty())
                                                    @foreach ($substschedule as $s => $art)
                                                            ...
                                                            @foreach ($art->footnoteModel as $f => $footnote)
                                                                <div
                                                                    ...
                                                                    <div class="show-footnote" style="display: block">
                                                                        ...
                                                                        <input type="hidden"
                                                                            name="stschedule_footnote_id[{{ $s }}][{{ $f }}]"
                                                                            value="{{ $footnote->footnote_id }}">

                                                                        <textarea type="text" name="stschedule_footnote_content[{{ $s }}][{{ $f }}]"
                                            ...
                                            @if ($sub_stschedule_f->count() > 0 || $count > 0)
                                                <div class="col-md-12 px-0 py-3">
                                                    <div class="float-right">
                                                        <span style="font-size: small;"
                                                            class="px-2 text-uppercase font-weight-bold">
                                                            (for add and remove Sub-Stschedule and
                                                            Footnote)
                                                        </span>
                                                        <button type="button"
                                        ...
                                        @if ($sub_stschedule_f->count() > 0 || $count > 0)
                                            @foreach ($sub_stschedule_f as $k => $subStscheduleItem)
                                                <div class="multi-addition-container col-md-12 px-0">
                                                    <div class="multi-addition">
                                                        ...
                                                        <input type="hidden" name="sub_stschedule_id[{{ $k }}]"
                                                            value="{{ $subStscheduleItem->sub_stschedule_id }}">
                                                        <div class="border col-md-12 p-3">
                                                            <div
                                                                ...
                                                                <label class="float-label">
                                                                    ...
                                                                    <span class="pl-2">
                                                                        <button type="button"
                                                                            class="btn btn-sm social facebook p-0 add-sub_stschedule">
                                                                            <i
                                                                                class="fa {{ $subStscheduleItem->sub_stschedule_no ? 'fa-plus' : 'fa-minus' }}"></i>
                                                                        </button>
                                                                    </span>
                                                                </label>
                                                                <div class="show-sub_stschedule">
                                                                    <span class="d-flex">
                                                                        <input type="text"
                                                                            name="sub_stschedule_no[{{ $k }}]"
                                                                            class="form-control mb-3"
                                                                            value="{{ $subStscheduleItem->sub_stschedule_no ?? '' }}"
                                                                            placeholder="Enter Sub-Schedule No."
                                                                            style="width: 20%;"
                                                                            data-index="{{ $k }}">

                                                                    </span>
                                                                    <textarea type="text" name="sub_stschedule_content[{{ $k }}]"
                                                                        class="form-control ckeditor-replace sub_section">{{ $subStscheduleItem->sub_stschedule_content ?? '' }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        @if (count($subStscheduleItem->footnoteModel) > 0)
                                                            @foreach ($subStscheduleItem->footnoteModel as $a => $footnoteItem)
                                                                <input type="hidden"
                                                        ...
                                                        <div class="col-md-12 px-0 py-3">
                                                            <div class="float-right">
                                                                <span style="font-size: small;"
                                                                    class="px-2 text-uppercase font-weight-bold">
                                                                    (for add and remove Sub-Schedule and
                                                                    Footnote)
                                                                </span>
                                                                <button type="button"
                                                                    class="btn btn-sm social facebook p-0 add-multi-addition">
    ...
    <script>
        $(document).ready(function() {
                                    ...
                                    <div class="border col-md-12 p-3">
                                        <div class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                            ...
                                            <div class="show-sub_stschedule" style="display: none">
                                                <span class="d-flex"><input type="text" name="sub_stschedule_no[${StscheduleCounterIndex}]" class="form-control mb-3" style="width: 20%" placeholder="Enter Sub-Schedule No." data-index="${StscheduleCounterIndex}">  </span>
                                                <textarea type="text" name="sub_stschedule_content[${StscheduleCounterIndex}]" class="form-control ckeditor-replace sub_stschedule" placeholder="Enter Sub-Schedule Ttile"></textarea>
                                            </div>
                                        </div>
            ...
            $(document).on('click', '.add-multi-footnote', function() {
                ...
                var lastInputFoot = $('[data-footstscheduleindex]:last').data('footstscheduleindex');
                var lastInputStschedule = $('[data-stscheduleindex]:last').data('stscheduleindex');
                ...
                var newStschedule = `<div class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12 footnote-addition">
                                        ...
                                        <div class="show-footnote" style="display: none">
                                            <textarea type="text" name="stschedule_footnote_content[${lastInputStschedule}][${footCounterIndex}]" class="form-control ckeditor-replace footnote"></textarea>
                                        </div>
