...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="{{ url('/edit_new_ordinance/' . $ordinanceTable->new_ordinace_id. '?perPage=10&page=' . $currentPage) }}"><button class="btn btn-success">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/add_new_ordinancetbl" method="post"
                    ...
                    @endif
                    <input type="hidden" name="click_ordinance_id" value="{{ $ordinanceTable->ordinances_id }}">
                    <input type="hidden" name="click_ordinance_rank" value="{{ $ordinanceTable->ordinances_rank }}">
                                ...
                                <div>
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            null
                                            @endif
                                            <textarea name="ordinance_main_title" class="form-control mb-3 rule_main_title" placeholder="Enter Title" id="ordinance_main_title">{{ $ordinanceTable->mainOrdinance->ordinance_main_title }}</textarea>
                                        </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            CKEDITOR.replace('ordinances_content');
            CKEDITOR.replace('ordinances_title');
