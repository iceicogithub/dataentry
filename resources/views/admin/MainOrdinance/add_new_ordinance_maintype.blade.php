...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="/edit_new_ordinance/{{ $mainOrdinance->new_ordinance_id }}?page={{ $currentPage }}">
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_ordinance_maintype" method="post"
                        ...
                        @endif
                        <input type="hidden" name="new_ordinance_id" value="{{ $mainOrdinance->new_ordinance_id }}">
                        <input type="hidden" name="click_main_rank" value="{{ $mainOrdinance->ordinance_main_rank }}">
                        <input type="hidden" name="ordinance_main_id" value="{{ $mainOrdinance->ordinance_main_id  }}">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    <label class="float-label">Ordinance<span class="text-danger">*</span></label>
                                    <input type="text" name="new_ordinance_title" class="form-control mb-3"
                                        placeholder="Enter Ordinance Title" value="{{ $mainOrdinance->newOrdinance->new_ordinance_title }}">
                                </div>
                            </div>
                                    ...
                                    <div class="px-0 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select form-control text-capitalize type typeSelector"
                                                name="ordinance_maintype_id[]" id="typeSelector">
                                                @foreach ($mtype as $item)
                                                    <option value="{{ $item->ordinance_maintype_id }}" class="text-capitalize">
                                                        {{ $item->type }}</option>
                                                @endforeach
                                    ...
                                    <div class="section-container border col-md-12 p-3">
                                        <div class="col-md-12 px-0">
                                            <div class="form-group form-default">
                                                ...
                                                <textarea name="ordinance_main_title[]" class="form-control mb-3 _title" placeholder="Enter Chapter Title"
                                                    id="ordinance_main_title"></textarea>
                                            ...
                                            <div class="border col-md-12 p-3">
                                                <div>
                                                    <div class="col-md-6 px-0">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                name="ordinance_subtypes_id[]" id="select">
                                                                <option selected disabled>Select</option>
                                                                @foreach ($stype as $item)
                                                                    <option value="{{ $item->ordinance_subtypes_id }}"
                                                    ...
                                                    <div class="form-group form-default col-md-12 px-0" id="1Div"
                                                        style="display:none">
                                                        <label class="float-label">Ordinance Title<span
                                                            class="text-danger">*</span></label>
                                                    </div>
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.add-chapter', function() {
                                    ...
                                    <div class="section-container border col-md-12 p-3">
                                        <div class="col-md-12 px-0">
                                            <div class="form-group form-default">
                                                ...
                                                <textarea name="ordinance_main_title[]" class="form-control mb-3 ordinance_main_title" placeholder="Enter Chapter Title"
                                                    id="ordinance_main_title"></textarea>
                    ...
                    CKEDITOR.replace($('.section-set:last').find('.ordinance_main_title')[0]);
                    CKEDITOR.replace($('.section-set:last').find('.parts_title')[0]);
