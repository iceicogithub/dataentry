                                    ...
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            @elseif($sections->maintype_id == 6)
                                                ...
                                                <textarea name="appendix_title" class="form-control mb-3 main_order_title" placeholder="Enter Order Title" id="m_title">{{ $sections->MainOrderModel->main_order_title }}</textarea>>
                                            @else
                                                null
                                            @endif
                                        </div>
