...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/add_new_section/{{ $act->act_id }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control text-capitalize category" name="category_id" disabled>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="act_title" class="form-control mb-3"
                                        placeholder="Enter Act Title" value="{{ $act->act_title }}" readonly>
                                </div>
                            </div>
