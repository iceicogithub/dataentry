            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="/get_act_section/{{$list->act_id}}?page={{ $currentPage }}"><button class="btn btn-danger">Back</button></a>
                    </ol>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Arrangement of Sub-Lists</strong>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($sub_list as $item)
                                    <tr>
                                        ...
                                        <td class="text-capitalize">{{ $item->sub_list_no }}</td>
                                        <td class="text-capitalize">{!! $item->sub_list_content !!}</td>
                                        <td class="text-capitalize">{{ $item->updated_at }}</td>
                                        <td class="text-capitalize d-flex justify-content-center">
                                            <a href="{{ url('/delete_sub_list/' . $item->sub_list_id) }}" title="Delete"
