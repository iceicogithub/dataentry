...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="/edit_new_regulation/{{ $newRegulation->new_regulation_id }}"><button class="btn btn-danger">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_regulation/{{ $newRegulation->new_regulation_id }}" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="new_regulation_title" class="form-control mb-3"
                                        placeholder="Enter Rule Title" value="{{ $newRegulation->new_regulation_title }}">
                                </div>
                            </div>
                                            ...
                                            <div id="appendixSection" class="appendixSection" style="display: none">
                                             ...
                                             <div id="sectionSection" class="sectionSection" style="display: none;">
                                                <label class="float-label">Section<span
                                                        class="text-danger">*</span></label>
                                                <textarea name="main_section_title[]" class="form-control mb-3 main_form_title" placeholder="Enter Form Title"
