...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="/edit_new_regulation/{{ $mainRegulation->new_regulation_id }}"><button class="btn btn-danger">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_regulation_maintype" method="post"
                        ...
                        @endif
                        <input type="hidden" name="new_regulation_id" value="{{ $mainRegulation->new_regulation_id }}">
                        <input type="hidden" name="click_main_rank" value="{{ $mainRegulation->regulation_main_rank }}">
                        <input type="hidden" name="regulation_main_id" value="{{ $mainRegulation->regulation_main_id }}">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    <label class="float-label">Regulation <span class="text-danger">*</span></label>
                                    <input type="text" name="new_regulation_title" class="form-control mb-3"
                                        placeholder="Enter regulation Title" value="{{ $mainRegulation->newRegulation->new_regulation_title }}">
                                </div>
                            </div>
                                    ...
                                    <div class="px-0 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select form-control text-capitalize type typeSelector"
                                                name="regulation_maintype_id[]" id="typeSelector">
                                                @foreach ($mtype as $item)
                                                    <option value="{{ $item->regulation_maintype_id }}" class="text-capitalize">
                                                        {{ $item->type }}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-12 px-0">
                                            <div class="form-group form-default">
                                                ...
                                                <div id="partSection" class="partSection" style="display: none">
                                                 ...
                                                 {{-- for Priliminary --}}
                                                <div id="annexureSection" class="annexureSection"
                                                    style="display: none">
                                                    <label class="float-label"> Annexure <span
                                                            class="text-danger">*</span></label>
                                                    <textarea name="main_annexure_title[]" class="form-control mb-3 main_annexure_title" placeholder="Enter Annexure Title"
                                                        id="main_annexure_title"></textarea>
                                                </div>
                                            </div>
                                            {{-- for schedule --}}
                                            ...
                                            <div id="appendixSection" class="appendixSection" style="display: none">
                                             ...
                                             {{-- for MainOrder --}}
                                             <div id="sectionSection" class="sectionSection" style="display: none;">
                                                <label class="float-label">Section<span
                                                        class="text-danger">*</span></label>
                                                <textarea name="main_section_title[]" class="form-control mb-3 main_form_title" placeholder="Enter section Title"
                                                    id="main_section_title"></textarea>
                                            </div>
                                        </div>
                                        <div class="additional-section">
                                            <div class="border col-md-12 p-3">
                                                <div>
                                                    <div class="col-md-6 px-0">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                name="regulation_subtypes_id[]" id="select">
                                                                <option selected disabled>Select</option>
                                                                @foreach ($stype as $item)
                                                                    <option value="{{ $item->regulation_subtypes_id }}"
                                                    ...
                                                    <div class="form-group form-default col-md-12 px-0" id="11Div"
                                                        style="display:none">
                                                        <div class="form-group form-default FormTitleMain"
                                                            style="display: block">
                                                            <label class="float-label">Form Title<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="d-flex formTitle my-1">
                                                                ...
                                                                <button type="button"
                                                                    class="add-formTitle btn btn-sm facebook mx-2 p-0 social">
                                                                    <i class="fa fa-plus"></i>
                                                                </button>
                                                                <button type="button"
                                                                    class="btn btn-sm social youtube p-0 remove-formTitle">
                                                                    <i class="fa fa-minus"></i>
                                                                </button>
                                                            </div>
                                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.typeSelector', function() {
                ...
                var annexureSection = sectionContainer.find('.annexureSection');
                var scheduleSection = sectionContainer.find('.scheduleSection');
                var appendixSection = sectionContainer.find('.appendixSection');
                var sectionSection = sectionContainer.find('.sectionSection');

                chapterSection.hide();
                partSection.hide();
                annexureSection.hide();
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.add-chapter', function() {
                                                    ...
                                                    <div class="form-group form-default col-md-12 px-0" id="11Div"
                                                        ...
                                                        <div class="form-group form-default FormTitleMain"
                                                            ...
                                                            <label class="float-label">Form Title<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="d-flex formTitle my-1">
                                                                <input type="text" name="form_no[${chapterCount}][]"
                                                                    class="form-control" style="width: 20%;"
                                                                    placeholder="Enter Form NO.">
                                                                <input type="text" name="form_title[${chapterCount}][]"
                                                                    class="form-control"
                                                                    placeholder="Enter Form Title">
                                                                <button type="button"
                                                                    class="add-formTitle btn btn-sm facebook mx-2 p-0 social">
                    ...
                    CKEDITOR.replace($('.section-set:last').find('.main_section_title')[0]);
