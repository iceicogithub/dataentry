...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/add_new_regulationtbl" method="post"
                    ...
                    @endif
                    <input type="hidden" name="click_regulations_id" value="{{ $regulationTable->regulations_id }}">
                    <input type="hidden" name="click_regulations_rank" value="{{ $regulationTable->regulations_rank }}">
                                ...
                                <div>
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            null
                                            @endif
                                            <textarea name="regulation_main_title" class="form-control mb-3 rule_main_title" placeholder="Enter Title" id="regulation_main_title">{{ $regulationTable->mainRegulation->regulation_main_title }}</textarea>
                                        </div>
                                        ...
                                        <div>
                                            <div class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                ...
                                                <div class="show-sub_section" style="display: none">
                                                    ...
                                                    <textarea type="text" name="regulation_sub_content[${sectionCounterIndex}]" class="form-control ckeditor-replace sub_section" placeholder="Enter Ttile"></textarea>
                                                </div>
                                            </div>
                                        </div>
