...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="{{ url('/edit_new_regulation/' . $regulationTable->mainRegulation->new_regulation_id . '?perPage=10&page=' . $currentPage) }}"><button class="btn btn-success">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/update_main_regulation/{{ $regulationTable->regulations_id }}" method="post"
                    ...
                    @endif
                    <input type="hidden" name="section_id" value="{{ $regulationTable->regulations_id }}">
                    <input type="hidden" name="currentPage" value="{{ $currentPage }}">
                    <input type="hidden" name="regulation_main_id" value="{{ $regulationTable->regulation_main_id }}">
                    <input type="hidden" name="new_regulation_id" value="{{ $regulationTable->mainRegulation->new_regulation_id }}">
                    <input type="hidden" name="regulation_subtypes_id" value="{{ $regulationTable->regulation_subtypes_id }}">
                    <div class="card p-5">
                                ...
                                <div>
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            @if ($regulationTable->mainRegulation->regulation_maintype_id == 1)
                                            <label class="float-label font-weight-bold">Chapter :</label>
                                            @elseif($regulationTable->mainRegulation->regulation_maintype_id == 2)
                                            <label class="float-label font-weight-bold">Schedule :</label>
                                            @elseif($regulationTable->mainRegulation->regulation_maintype_id == 3)
                                            <label class="float-label font-weight-bold">Annexure :</label>
                                            @elseif($regulationTable->mainRegulation->regulation_maintype_id == 4)
                                            <label class="float-label font-weight-bold">Part :</label>
                                            @elseif($regulationTable->mainRegulation->regulation_maintype_id == 5)
                                            <label class="float-label font-weight-bold">Appendix :</label>
                                            @elseif($regulationTable->mainRegulation->regulation_maintype_id == 6)
                                            <label class="float-label font-weight-bold">Section :</label>
                                            @else
                                            null
                                            @endif
                                            <textarea name="regulation_main_title" class="form-control mb-3 regulation_main_title" placeholder="Enter Title" id="regulation_main_title">{{ $regulationTable->mainRegulation->regulation_main_title }}</textarea>
                                        </div>

                                        <div class="form-group form-default" style="display: block">
                                            @if ($regulationTable->regulation_subtypes_id == 1)
                                            <label class="float-label font-weight-bold">Section :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 2)
                                            <label class="float-label font-weight-bold">Article :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 3)
                                            <label class="float-label font-weight-bold">Rule :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 4)
                                            <label class="float-label font-weight-bold">Regulation :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 5)
                                            <label class="float-label font-weight-bold">List :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 6)
                                            <label class="float-label font-weight-bold">Part :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 7)
                                            <label class="float-label font-weight-bold">Appendices :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 8)
                                            <label class="float-label font-weight-bold">Order :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 9)
                                            <label class="float-label font-weight-bold">Annexure :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 10)
                                            <label class="float-label font-weight-bold">Schedule :</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 11 )
                                            <label class="float-label font-weight-bold">Form :</label>
                                            @else
                                            null
                                            @endif
                                            
                                            <input type="text" name="regulations_no" class="form-control my-3"
                                                style="width: 20%;" placeholder="Enter NO."
                                                value="{{ $regulationTable->regulations_no }}">
                                                <textarea type="text" id="regulations_title" name="regulations_title"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Title">{{ $regulationTable->regulations_title }}</textarea>
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            @if ($regulationTable->regulation_subtypes_id == 1)
                                            <label class="float-label font-weight-bold">Section Description:</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 2)
                                            <label class="float-label font-weight-bold">Article Description:</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 3)
                                            <label class="float-label font-weight-bold">Rule Description:</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 4)
                                            <label class="float-label font-weight-bold">Regulation Description:</label>
                                            @elseif($regulationTable->regulation_subtypes_id == 5)
                                            ...
                                            null
                                            @endif
                                            <textarea type="text" id="regulations_content" name="regulations_content"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Section">{{ $regulationTable->regulations_content }}</textarea>

                                            <div class="footnote-addition-container">
                                                @if (!empty($regulationTable->regulationFootnoteModel))
                                                    @foreach ($regulationTable->regulationFootnoteModel as $ky => $footnote)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        ...
                                                                        <div>
                                                                            <a href="{{ url('/delete_regulation_footnote/' . $footnote->regulation_footnote_id . '?perPage=10&page=' . $currentPage ) }}"
                                                                    ...
                                                                    <div class="show-footnote" style="display: block">
                                                                        ...
                                                                        <input type="hidden"
                                                                            ...
                                                                            value="{{ $footnote->regulation_footnote_id  }}">
                                                ...
                                                @if (count($regulationTable->regulationFootnoteModel) < 1)
                                        ...
                                        @if ($regulationSubs->count() > 0)
                                            @foreach ($regulationSubs as $k => $regulationSub)
                                                <div class="multi-addition-container col-md-12 px-0">
                                                    <div class="multi-addition">
                                                        ...
                                                        <input type="hidden" name="regulation_sub_id[{{ $k }}]"
                                                            value="{{ $regulationSub->regulation_sub_id }}">
                                                        <div class="border col-md-12 p-3">
                                                            <div
                                                                class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                                <span>
                                                                    @if ($regulationSub->regulation_subtypes_id == 1)
                                                                    <label class="float-label font-weight-bold">Add Sub Section :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 2)
                                                                    <label class="float-label font-weight-bold">Add Sub Article :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 3)
                                                                    <label class="float-label font-weight-bold">Add Sub Rule :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 4)
                                                                    <label class="float-label font-weight-bold">Add Sub Regulation :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 5)
                                                                    <label class="float-label font-weight-bold">Add Sub List :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 6)
                                                                    <label class="float-label font-weight-bold">Add Sub Part :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 7)
                                                                    <label class="float-label font-weight-bold">Add Sub Appendices :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 8)
                                                                    <label class="float-label font-weight-bold">Add Sub Order :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 9)
                                                                    <label class="float-label font-weight-bold">Add Sub Annexure :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 10)
                                                                    <label class="float-label font-weight-bold">Add Sub Schedule :</label>
                                                                    @elseif($regulationSub->regulation_subtypes_id == 11)
                                                                    <label class="float-label font-weight-bold">Add Sub Form :</label>
                                                                    @else
                                                                    null
                                                                    @endif
                                                                    <button type="button"
                                                                        ...
                                                                        <i
                                                                            class="fa {{ $regulationSub->regulation_sub_no ? 'fa-minus' : 'fa-plus' }}"></i>
                                                                    </button>
                                                               </span>
                                                                ...
                                                                <div class="show-sub_section">
                                                                    <span class="d-flex">
                                                                        <input type="text"
                                                                            name="regulation_sub_no[{{ $k }}]"
                                                                            class="form-control mb-3"
                                                                            value="{{ $regulationSub->regulation_sub_no ?? '' }}"
                                                                            placeholder="Enter Sub-Section No."
                                                                            style="width: 20%;"
                                                                            data-index="{{ $k }}">

                                                                    </span>
                                                                    <textarea type="text" name="regulation_sub_content[{{ $k }}]"
                                                                        class="form-control ckeditor-replace sub_section">{{ $regulationSub->regulation_sub_content ?? '' }}</textarea>
                                                                </div>
                                                            </div>

                                                            @if (count($regulationSub->regulationSubFootnoteModel) > 0)
                                                            @foreach ($regulationSub->regulationSubFootnoteModel as $a => $footnoteItem)
                                                                <input type="hidden"
                                                                    name="sub_footnote_id[{{ $k }}][{{ $a }}]"
                                                                    value="{{ $footnoteItem->regulation_footnote_id }}">
                                                                <div class="border col-md-12 p-3">
                                                                    <div
                                                                        class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                                        <div class="d-flex justify-content-between">
                                                                            ...
                                                                            <div>
                                                                                <a href="{{ url('/delete_regulation_footnote/' . $footnoteItem->regulation_footnote_id) }}"
                                                                                    onclick="return confirm('Are you sure ?')"><i
                                                                                        class="bg-danger btn-sm fa fa-trash p-1 text-white"></i></a>
                                                                            </div>
                                                                        </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            CKEDITOR.replace('regulation_main_title');
            CKEDITOR.replace('regulations_content');
            CKEDITOR.replace('regulations_title');
            ...
            $(document).on('click', '.add-multi-addition', function() {
                var regulationSubtypesId = {{ $regulationTable->regulation_subtypes_id }};
                console.log(regulationSubtypesId);

                var labelText;

switch (regulationSubtypesId) {
    case 1:
        labelText = "Add Sub Section :";
        break;
    case 2:
        labelText = "Add Sub Article :";
        break;
    case 3:
        labelText = "Add Sub Rule :";
        break;
    case 4:
        labelText = "Add Sub Regulation :";
        break;
    case 5:
    ...
    default:
        labelText = "null";
                                        ...
                                        <div>
                                            <div class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                ...
                                                <div class="show-sub_section" style="display: none">
                                                    <span class="d-flex"><input type="text" name="regulation_sub_no[${sectionCounterIndex}]" class="form-control mb-3" style="width: 20%" placeholder="Enter No." data-index="${sectionCounterIndex}"></span>
                                                    <textarea type="text" name="regulation_sub_content[${sectionCounterIndex}]" class="form-control ckeditor-replace sub_section" placeholder="Enter Sub-Section Ttile"></textarea>
                                                </div>
                                            </div>
                                        </div>
                ...
                $('.multi-addition').each(function(index) {
                    var newIndex = index;
                    $(this).find(`[name^="regulation_sub_no["]`).attr('name',
                        `regulation_sub_no[${newIndex}]`);
                    $(this).find(`[name^="regulation_sub_content["]`).attr('name',
                        `regulation_sub_content[${newIndex}]`);
            ...
            $(document).on('click', '.add-multi-footnote2', function() {
                ...
                var associatedSubSectionTitle = multiAdditionContainer.find('[name^="regulation_sub_no["]');
