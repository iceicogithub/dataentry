...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="/edit_new_scheme_guidelines/{{ $mainSchemeGuidelines->new_scheme_guidelines_id }}"><button class="btn btn-danger">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_scheme_guidelines_maintype" method="post"
                        ...
                        @endif
                        <input type="hidden" name="new_scheme_guidelines_id" value="{{ $mainSchemeGuidelines->new_scheme_guidelines_id }}">
                        <input type="hidden" name="click_main_rank" value="{{ $mainSchemeGuidelines->scheme_guidelines_main_rank }}">
                        <input type="hidden" name="scheme_guidelines_main_id" value="{{ $mainSchemeGuidelines->scheme_guidelines_main_id  }}">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    <label class="float-label">Scheme/Guidelines<span class="text-danger">*</span></label>
                                    <input type="text" name="new_scheme_guidelines_title" class="form-control mb-3"
                                        placeholder="Enter Scheme/Guidelines Title" value="{{ $mainSchemeGuidelines->newschemeGuidelines->new_scheme_guidelines_title }}">
                                </div>
                            </div>
                                    ...
                                    <div class="px-0 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select form-control text-capitalize type typeSelector"
                                                name="scheme_guidelines_maintype_id[]" id="typeSelector">
                                                @foreach ($mtype as $item)
                                                    <option value="{{ $item->scheme_guidelines_maintype_id }}" class="text-capitalize">
                                                        {{ $item->type }}</option>
                                                @endforeach
                                    ...
                                    <div class="section-container border col-md-12 p-3">
                                        <div class="col-md-12 px-0">
                                            <div class="form-group form-default">
                                                ...
                                                <textarea name="scheme_guidelines_main_title[]" class="form-control mb-3 _title" placeholder="Enter Chapter Title"
                                                    ...
                                                    <div class="col-md-6 px-0">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                name="scheme_guidelines_subtypes_id[]" id="select">
                                                                <option selected disabled>Select</option>
                                                                @foreach ($stype as $item)
                                                                    <option value="{{ $item->scheme_guidelines_subtypes_id }}"
                                    ...
                                    <div class="section-container border col-md-12 p-3">
                                        <div class="col-md-12 px-0">
                                            <div class="form-group form-default">
                                                ...
                                                <textarea name="scheme_guidelines_main_title[]" class="form-control mb-3 scheme_guidelines_main_title" placeholder="Enter Chapter Title"
                                                    id="scheme_guidelines_main_title"></textarea>
