...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="/edit_new_scheme_guidelines/{{ $newSchemeGuidelines->new_scheme_guidelines_id }}"><button class="btn btn-danger">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/store_scheme_guidelines/{{ $newSchemeGuidelines->new_scheme_guidelines_id }}" method="post"
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="new_scheme_guidelines_title" class="form-control mb-3"
                                        placeholder="Enter Rule Title" value="{{ $newSchemeGuidelines->new_scheme_guidelines_title }}">
                                </div>
                            </div>
