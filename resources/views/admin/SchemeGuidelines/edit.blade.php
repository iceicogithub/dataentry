...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/update_main_scheme_guidelines/{{ $schemeGuidelinesTable->scheme_guidelines_id }}" method="post"
                    ...
                    @endif
                    <input type="hidden" name="section_id" value="{{ $schemeGuidelinesTable->scheme_guidelines_id }}">
                    <input type="hidden" name="currentPage" value="{{ $currentPage }}">
                    <input type="hidden" name="scheme_guidelines_main_id" value="{{ $schemeGuidelinesTable->scheme_guidelines_main_id }}">
                    <input type="hidden" name="new_scheme_guidelines_id" value="{{ $schemeGuidelinesTable->mainschemeGuidelines->new_scheme_guidelines_id }}">
                                ...
                                <div>
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            null
                                            @endif
                                            <textarea name="scheme_guidelines_main_title" class="form-control mb-3 regulation_main_title" placeholder="Enter Title" id="scheme_guidelines_main_title">{{ $schemeGuidelinesTable->mainschemeGuidelines->scheme_guidelines_main_title }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            <input type="text" name="scheme_guidelines_no" class="form-control my-3"
                                                ...
                                                value="{{ $schemeGuidelinesTable->scheme_guidelines_no }}">
                                                <textarea type="text" id="scheme_guidelines_title" name="scheme_guidelines_title"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Title">{{ $schemeGuidelinesTable->scheme_guidelines_title }}</textarea>
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            <textarea type="text" id="scheme_guidelines_content" name="scheme_guidelines_content"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Section">{{ $schemeGuidelinesTable->scheme_guidelines_content }}</textarea>

                                            <div class="footnote-addition-container">
                                                @if (!empty($schemeGuidelinesTable->schemeGuidelinesFootnoteModel))
                                                    @foreach ($schemeGuidelinesTable->schemeGuidelinesFootnoteModel as $ky => $footnote)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        ...
                                                                        <div>
                                                                            <a href="{{ url('/delete_scheme_guidelines_footnote/' . $footnote->scheme_guidelines_footnote_id . '?perPage=10&page=' . $currentPage ) }}"
                                                                    ...
                                                                    <div class="show-footnote" style="display: block">
                                                                        ...
                                                                        <input type="hidden"
                                                                            ...
                                                                            value="{{ $footnote->scheme_guidelines_footnote_id  }}">
                                                ...
                                                @if (count($schemeGuidelinesTable->schemeGuidelinesFootnoteModel) < 1)
                                        ...
                                        @if ($schemeGuidelinesSubs->count() > 0)
                                            @foreach ($schemeGuidelinesSubs as $k => $schemeGuidelinesSub)
                                                <div class="multi-addition-container col-md-12 px-0">
                                                    <div class="multi-addition">
                                                        ...
                                                        <input type="hidden" name="scheme_guidelines_sub_id[{{ $k }}]"
                                                            value="{{ $schemeGuidelinesSub->scheme_guidelines_sub_id }}">
                                                        <div class="border col-md-12 p-3">
                                                            <div
                                                                class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                                <span>
                                                                    @if ($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 1)
                                                                    <label class="float-label font-weight-bold">Add Sub Scheme :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 2)
                                                                    <label class="float-label font-weight-bold">Add Sub Guidelines :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 3)
                                                                    <label class="float-label font-weight-bold">Add Sub List  :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 4)
                                                                    <label class="float-label font-weight-bold">Add Sub Part :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 5)
                                                                    <label class="float-label font-weight-bold">Add Sub Appendices :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 6)
                                                                    <label class="float-label font-weight-bold">Add Sub Order :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 7)
                                                                    <label class="float-label font-weight-bold">Add Sub Annexure :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 8)
                                                                    <label class="float-label font-weight-bold">Add Sub Schedule :</label>
                                                                    @elseif($schemeGuidelinesSub->scheme_guidelines_subtypes_id == 9)
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        <i
                                                                            class="fa {{ $schemeGuidelinesSub->scheme_guidelines_sub_no ? 'fa-minus' : 'fa-plus' }}"></i>
                                                                    </button>
                                                               </span>
                                                                ...
                                                                <div class="show-sub_section">
                                                                    <span class="d-flex">
                                                                        <input type="text"
                                                                            name="scheme_guidelines_sub_no[{{ $k }}]"
                                                                            class="form-control mb-3"
                                                                            value="{{ $schemeGuidelinesSub->scheme_guidelines_sub_no ?? '' }}"
                                                                            placeholder="Enter Sub-Section No."
                                                                            style="width: 20%;"
                                                                            data-index="{{ $k }}">

                                                                    </span>
                                                                    <textarea type="text" name="scheme_guidelines_sub_content[{{ $k }}]"
                                                                        class="form-control ckeditor-replace sub_section">{{ $schemeGuidelinesSub->scheme_guidelines_sub_content ?? '' }}</textarea>
                                                                </div>
                                                            </div>

                                                            @if (count($schemeGuidelinesSub->schemeGuidelinesSubFootnoteModel) > 0)
                                                            @foreach ($schemeGuidelinesSub->schemeGuidelinesSubFootnoteModel as $a => $footnoteItem)
                                                                <input type="hidden"
                                                                    name="sub_footnote_id[{{ $k }}][{{ $a }}]"
                                                                    value="{{ $footnoteItem->scheme_guidelines_footnote_id }}">
                                                                <div class="border col-md-12 p-3">
                                                                    <div
                                                                        class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                                        <div class="d-flex justify-content-between">
                                                                            ...
                                                                            <div>
                                                                                <a href="{{ url('/delete_scheme_guidelines_footnote/' . $footnoteItem->scheme_guidelines_footnote_id) }}"
                                                                                    onclick="return confirm('Are you sure ?')"><i
                                                                                        class="bg-danger btn-sm fa fa-trash p-1 text-white"></i></a>
                                                                            </div>
                                                                        </div>
