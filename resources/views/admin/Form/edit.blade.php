...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="{{ route('get_forms', array_merge(['id' => $form->act_id], ['page' => $currentPage])) }}">
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/update_form/{{$form->forms_id}}" method="post" enctype="multipart/form-data"
                        ...
                        @endif
                        <input type="hidden" name="act_id" id="act_id" value="{{$form->act_id}}">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <input type="text" name="forms_title" class="form-control mb-3"
                                        placeholder="Enter Form" required value="{{$form->forms_title}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-default">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    ...
                                    <textarea type="text" name="ministry" value=""
                                        class="form-control mb-3" id="ministry">{{$form->ministry}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group form-default">
                                    <label class="float-label">Form Date<span class="text-danger">*</span></label>
                                    <input type="text" name="forms_date" value="{{$form->forms_date}}"
