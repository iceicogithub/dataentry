                                            ...
                                            <div class="form-group form-default">
                                                ...
                                                <div id="annexureSection" class="annexureSection"
                                                    ...
                                                    <label class="float-label"> Annexure <span
                                                            class="text-danger">*</span></label>
                                                    <textarea name="annexure_title[]" class="form-control mb-3 priliminary_title" placeholder="Enter Annexure Title"
                                                        id="annexure_title"></textarea>
                                                </div>
                                            </div>
                                            {{-- for schedule --}}
                                            ...
                                            <div id="appendixSection" class="appendixSection" style="display: none">
                                             ...
                                             <div id="formSection" class="formSection" style="display: none;">
                                                <label class="float-label">Form<span
                                                        class="text-danger">*</span></label>
                                                <textarea name="form_title[]" class="form-control mb-3 form_title" placeholder="Enter Form Title"
                                                    id="form_title"></textarea>
                                            </div>
                                        </div>
