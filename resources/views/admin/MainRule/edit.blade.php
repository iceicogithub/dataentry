...
@section('content')
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <a href="{{ url('/edit_new_rule/' . $ruleTable->mainrule->new_rule_id . '?perPage=10&page=' . $currentPage) }}"><button class="btn btn-success">Back</button></a>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/update_main_rule/{{ $ruleTable->rules_id }}" method="post"
                    ...
                    @endif
                    <input type="hidden" name="section_id" value="{{ $ruleTable->rules_id }}">
                    <input type="hidden" name="currentPage" value="{{ $currentPage }}">
                    <input type="hidden" name="rule_main_id" value="{{ $ruleTable->rule_main_id }}">
                    <input type="hidden" name="new_rule_id" value="{{ $ruleTable->mainRule->new_rule_id }}">
                    <input type="hidden" name="rule_subtypes_id" value="{{ $ruleTable->rule_subtypes_id }}">
                    <div class="card p-5">
                                ...
                                <div>
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            @if ($ruleTable->mainRule->rule_maintype_id == 1)
                                            <label class="float-label font-weight-bold">Chapter :</label>
                                            @elseif($ruleTable->mainRule->rule_maintype_id == 2)
                                            <label class="float-label font-weight-bold">Schedule :</label>
                                            @elseif($ruleTable->mainRule->rule_maintype_id == 3)
                                            <label class="float-label font-weight-bold">Annexure :</label>
                                            @elseif($ruleTable->mainRule->rule_maintype_id == 4)
                                            <label class="float-label font-weight-bold">Part :</label>
                                            @elseif($ruleTable->mainRule->rule_maintype_id == 5)
                                            <label class="float-label font-weight-bold">Appendix :</label>
                                            @elseif($ruleTable->mainRule->rule_maintype_id == 6)
                                            <label class="float-label font-weight-bold">Form :</label>
                                            @else
                                            null
                                            @endif
                                            <textarea name="rule_main_title" class="form-control mb-3 rule_main_title" placeholder="Enter Title" id="rule_main_title">{{ $ruleTable->mainRule->rule_main_title }}</textarea>
                                        </div>

                                        <div class="form-group form-default" style="display: block">
                                            @if ($ruleTable->rule_subtypes_id == 1)
                                            <label class="float-label font-weight-bold">Section :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 2)
                                            <label class="float-label font-weight-bold">Article :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 3)
                                            <label class="float-label font-weight-bold">Rule :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 4)
                                            <label class="float-label font-weight-bold">Regulation :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 5)
                                            <label class="float-label font-weight-bold">List :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 6)
                                            <label class="float-label font-weight-bold">Part :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 7)
                                            <label class="float-label font-weight-bold">Appendices :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 8)
                                            <label class="float-label font-weight-bold">Order :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 9)
                                            <label class="float-label font-weight-bold">Annexure :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 10)
                                            <label class="float-label font-weight-bold">Schedule :</label>
                                            @elseif($ruleTable->rule_subtypes_id == 11 )
                                            <label class="float-label font-weight-bold">Form :</label>
                                            @else
                                            null
                                            @endif
                                            
                                            <input type="text" name="rules_no" class="form-control my-3"
                                                style="width: 20%;" placeholder="Enter NO."
                                                value="{{ $ruleTable->rules_no }}">
                                                <textarea type="text" id="rules_title" name="rules_title"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Title">{{ $ruleTable->rules_title }}</textarea>
                                        ...
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            null
                                            @endif
                                            <textarea type="text" id="rules_content" name="rules_content"
                                                class="form-control section-textarea ckeditor-replace section" placeholder="Enter Section">{{ $ruleTable->rules_content }}</textarea>

                                            <div class="footnote-addition-container">
                                                @if (!empty($ruleTable->ruleFootnoteModel))
                                                    @foreach ($ruleTable->ruleFootnoteModel as $ky => $footnote)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="show-footnote" style="display: block">
                                                                        ...
                                                                        <input type="hidden"
                                                                            ...
                                                                            value="{{ $footnote->rule_footnote_id  }}">
                                                ...
                                                @if (count($ruleTable->ruleFootnoteModel) < 1)
                                        ...
                                        @if ($ruleSubs->count() > 0)
                                            @foreach ($ruleSubs as $k => $ruleSubs)
                                                            ...
                                                            <div
                                                                ...
                                                                <span>
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        <i
                                                                            class="fa {{ $ruleSubs->rule_sub_no ? 'fa-minus' : 'fa-plus' }}"></i>
                                                                    </button>
                                                               </span>
                                                                ...
                                                                <div class="show-sub_section">
                                                                    <span class="d-flex">
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $ruleSubs->rule_sub_no ?? '' }}"
                                                                            placeholder="Enter Sub-Section No."
                                                                            style="width: 20%;"
                                                                            data-index="{{ $k }}">

                                                                    </span>
                                                                    <textarea type="text" name="rule_sub_content[{{ $k }}]"
                                                                        class="form-control ckeditor-replace sub_section">{{ $ruleSubs->rule_sub_content ?? '' }}</textarea>
                                                                </div>
                                                            </div>

                                                            @if (count($ruleSubs->ruleSubFootnoteModel) > 0)
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            CKEDITOR.replace('rule_main_title');
            ...
            $(document).on('click', '.add-multi-addition', function() {
                var ruleSubtypesId = {{ $ruleTable->rule_subtypes_id }};
                console.log(ruleSubtypesId);

                var labelText;

switch (ruleSubtypesId) {
    case 1:
    ...
    default:
        labelText = "null";
                                        ...
                                        <div>
                                            <div class="form-group form-default fa fa-arrow-circle-o-right p-0 col-md-12">
                                                ...
                                                <div class="show-sub_section" style="display: none">
                                                    <span class="d-flex"><input type="text" name="rule_sub_no[${sectionCounterIndex}]" class="form-control mb-3" style="width: 20%" placeholder="Enter Sub-Section No." data-index="${sectionCounterIndex}">  </span>
                                                    <textarea type="text" name="rule_sub_content[${sectionCounterIndex}]" class="form-control ckeditor-replace sub_section" placeholder="Enter Sub-Section Ttile"></textarea>
                                                </div>
                                            </div>
                                        </div>
                ...
                $('.multi-addition').each(function(index) {
                    var newIndex = index;
                    $(this).find(`[name^="rule_sub_no["]`).attr('name',
                        `rule_sub_no[${newIndex}]`);
                    $(this).find(`[name^="rule_sub_content["]`).attr('name',
                        `rule_sub_content[${newIndex}]`);
            ...
            $(document).on('click', '.add-multi-footnote2', function() {
                ...
                var associatedSubSectionTitle = multiAdditionContainer.find('[name^="rule_sub_no["]');
