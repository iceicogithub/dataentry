...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/add_new_ruletbl" method="post"
                    ...
                    @endif
                    <input type="hidden" name="click_rules_id" value="{{ $ruleTable->rules_id }}">
                    <input type="hidden" name="click_rules_rank" value="{{ $ruleTable->rules_rank }}">
