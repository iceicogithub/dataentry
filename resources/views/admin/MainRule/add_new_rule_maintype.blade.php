                                    ...
                                    <div class="px-0 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select form-control text-capitalize type typeSelector"
                                                name="rule_maintype_id[]" id="typeSelector">
                                                @foreach ($mtype as $item)
                                                    <option value="{{ $item->rule_maintype_id }}" class="text-capitalize">
                                                        {{ $item->type }}</option>
                                                @endforeach
                                            ...
                                            <div id="appendixSection" class="appendixSection" style="display: none">
                                             ...
                                             <div id="formSection" class="formSection" style="display: none;">
                                                <label class="float-label">Form<span
                                                        class="text-danger">*</span></label>
                                                <textarea name="main_form_title[]" class="form-control mb-3 main_form_title" placeholder="Enter Form Title"
                                                    id="main_form_title"></textarea>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-6 px-0">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                name="rule_subtypes_id[]" id="select">
                                                                <option selected disabled>Select</option>
                                                                @foreach ($stype as $item)
                                                                    <option value="{{ $item->rule_subtypes_id }}"
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            CKEDITOR.replace('main_form_title');
