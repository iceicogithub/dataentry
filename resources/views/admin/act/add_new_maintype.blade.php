...
@section('content')
    ...
    <div class="content mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-5">
                    <form id="form" action="/add_new_main_type/{{ $act->act_id }}" method="post"
                        ...
                        <div class="row">
                            <input type="hidden" name="click_main_rank" value="{{ $data->main_rank }}">
                            <input type="hidden" name="click_serial_no" value="{{ $data->serial_no }}">
                            <div class="col-md-6">
