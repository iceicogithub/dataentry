        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="form" action="/add_new_appendices" method="post" enctype="multipart/form-data"
                    ...
                    @endif
                    <input type="hidden" name="click_appendices_rank" value="{{ $appendices->appendices_rank }}">
                    <input type="hidden" name="serial_no" value="{{ $appendices->serial_no }}">
                                    ...
                                    <div class="form-group form-default col-md-12 px-0" id="sectionDiv">
                                        <div class="form-group form-default" style="display: block">
                                            ...
                                            @elseif($appendices->maintype_id == 6)
                                                ...
                                                <textarea name="main_order_title" class="form-control mb-3 main_order_title" placeholder="Enter Order Title" id="m_title">{{ $appendices->MainOrderModel->main_order_title }}</textarea>
                                            @else
                                                null
                                            @endif
                                        </div>
