...
class Orders extends Model
{
    ...
    protected $fillable = ['order_no', 'order_rank' , 'act_id', 'maintype_id', 'chapter_id', 'subtypes_id', 'parts_id', 'order_title', 'order_content','appendix_id','schedule_id','priliminary_id','main_order_id','is_append', 'serial_no'];
