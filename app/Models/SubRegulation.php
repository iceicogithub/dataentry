...
class SubRegulation extends Model
{
    ...
    protected $fillable = ['sub_regulation_no', 'regulation_id', 'regulation_no', 'act_id','appendices_id','schedule_id', 'chapter_id', 'parts_id','priliminary_id', 'sub_regulation_title', 'sub_regulation_content'];
