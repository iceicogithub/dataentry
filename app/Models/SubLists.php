...
class SubLists extends Model
{
    ...
    protected $fillable = ['sub_list_no', 'list_id', 'list_no', 'act_id','appendix_id','schedule_id', 'chapter_id', 'parts_id','priliminary_id','main_order_id', 'sub_list_title', 'sub_list_content'];
