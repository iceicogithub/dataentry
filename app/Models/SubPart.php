...
class SubPart extends Model
{
    ...
    protected $fillable = ['sub_part_no', 'part_id', 'part_no', 'act_id','appendix_id','schedule_id', 'chapter_id', 'parts_id','priliminary_id','main_order_id', 'sub_part_title', 'sub_part_content'];
