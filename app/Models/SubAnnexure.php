...
class SubAnnexure extends Model
{
    ...
    protected $fillable = ['sub_annexure_no', 'annexure_id', 'annexure_no', 'act_id','appendix_id','schedule_id', 'chapter_id', 'parts_id','priliminary_id','main_order_id', 'sub_annexure_title', 'sub_annexure_content'];
