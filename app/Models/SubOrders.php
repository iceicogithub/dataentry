...
class SubOrders extends Model
{
    ...
    protected $fillable = ['sub_order_no', 'order_id', 'order_no', 'act_id','appendix_id','schedule_id', 'chapter_id', 'parts_id','priliminary_id','main_order_id', 'sub_order_title', 'sub_order_content'];
