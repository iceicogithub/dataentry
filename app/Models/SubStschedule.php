...
class SubStschedule extends Model
{
    ...
    protected $fillable = ['sub_stschedule_no', 'stschedule_id', 'stschedule_no', 'act_id','appendix_id','schedule_id', 'chapter_id', 'parts_id','priliminary_id','main_order_id', 'sub_stschedule_title', 'sub_stschedule_content'];
