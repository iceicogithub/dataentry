        ...
        try {
            ...
            $partsubs = Part::where('act_id', $id)
                ...
                ->sortBy(function ($partsub) {
                    // Sorting conditions
                return [floatval($partsub->part_rank)];  
            ...
            $Appendices = Appendices::where('act_id', $id)
                ...
                ->get()
                ->sortBy(function ($Appendice) {
                       // Sorting conditions
                return [floatval($Appendice->appendices_rank)];       
            });
            ...
            $Annexures = Annexure::where('act_id', $id)
                ...
                ->orWhereIn('schedule_id', $schedules->pluck('schedule_id'))
                ->orWhereIn('appendix_id', $Appendix->pluck('appendix_id'))
                ->with('subAnnexureModel','footnoteModel', 'Partmodel', 'ChapterModel','PriliminaryModel','Schedulemodel','Appendixmodel')
                ->get()
            ...
            foreach ($chapter as $item) {
                ...
                foreach ($Annexures as $index => $Annexure) {
                    if ($Annexure->chapter_id == $item->chapter_id) {
                        ...
                        $chapterSections[] = '<div id="' . $Annexure->annexure_id . '"><div style="display:flex!important"><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_no . '</h4><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_title . '</h4></div></br><div>' . $Annexure->annexure_content . '</div><div>' . $subAnnexureString . '</div><hr style="width:10%!important;margin: 10px auto !important;">' . $footnoteString . '</div>';
                    }
                }
        ...
        //   die();
            ...
            foreach ($part as $item) {
                ...
                foreach ($Annexures as $index => $Annexure) {
                    if ($Annexure->parts_id == $item->parts_id) {
                        ...
                        $partSections[] = '<div id="' . $Annexure->annexure_id . '"><div style="display:flex!important"><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_no . '</h4><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_title . '</h4></div></br><div>' . $Annexure->annexure_content . '</div><div>' . $subAnnexureString . '</div><hr style="width:10%!important;margin: 10px auto !important;">' . $footnoteString . '</div>';
                    }
                }
            ...
            foreach ($priliminarys as $item) {
                ...
                foreach ($Annexures as $index => $Annexure) {
                    if ($Annexure->priliminary_id == $item->priliminary_id) {
                        ...
                        $priliminarySections[] = '<div id="' . $Annexure->annexure_id . '"><div style="display:flex!important"><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_no . '</h4><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_title . '</h4></div></br><div>' . $Annexure->annexure_content . '</div><div>' . $subAnnexureString . '</div><hr style="width:10%!important;margin: 10px auto !important;">' . $footnoteString . '</div>';
                    }
                }
            ...
            foreach ($schedules as $item) {
                ...
                foreach ($Annexures as $index => $Annexure) {
                    if ($Annexure->schedule_id == $item->schedule_id) {
                        ...
                        $scheduleSections[] = '<div id="' . $Annexure->annexure_id . '"><div style="display:flex!important"><h4 class="font-weight-bold mb-3">' . $Annexure->Annexure_no . '</h4><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_title . '</h4></div></br><div>' . $Annexure->annexure_content . '</div><div>' . $subAnnexureString . '</div><hr style="width:10%!important;margin: 10px auto !important;">' . $footnoteString . '</div>';
                    }
                }
            ...
            foreach ($Appendix as $item) {
                ...
                foreach ($Annexures as $index => $Annexure) {
                    if ($Annexure->appendix_id == $item->appendix_id) {
                        ...
                        $appendixSections[] = '<div id="' . $Annexure->annexure_id . '"><div style="display:flex!important"><h4 class="font-weight-bold mb-3">' . $Annexure->Annexure_no . '</h4><h4 class="font-weight-bold mb-3">' . $Annexure->annexure_title . '</h4></div></br><div>' . $Annexure->annexure_content . '</div><div>' . $subAnnexureString . '</div><hr style="width:10%!important;margin: 10px auto !important;">' . $footnoteString . '</div>';
                    }
                }
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'actDescription' => '<h1 id=""><strong>' . $act->act_title . '</strong> </h1><div><strong>' . $act->act_no . '</strong></div><div><strong>' . $act->act_date . '</strong></div>' . implode('', $chapterList) . '' . implode('', $partList) . '' . implode('', $priliminaryList) .'' . implode('', $ScheduleList) .'' . implode('', $AppendixList) . '',
